...
public class Databricks_Cluster_List {
...
//		System.out.println("Response:-" + jsonObject.getString("state"));
		...
		for (Object key : jsonObject.keySet()) {
			...
			for (int i = 0; i < object.length(); i++) {
				...
				String cluster_name = jsonObjectJobs2.getString("cluster_name");
				String cluster_ID = jsonObjectJobs2.getString("cluster_id");
				String creator = jsonObjectJobs2.getString("creator_user_name");
				String state = jsonObjectJobs2.getString("state");
				String instance_source1 = jsonObjectJobs2.get("instance_source").toString();
